...
**Эмулятор ZX Spectrum на базе микроконтроллеров Raspberry Pi RP2040 и RP2350.**
...
- **Частоты**: Автоматическое определение, доступны режимы 378 МГц, 315 МГц, 252 МГц с различными настройками HDMI и PSRAM.
- **Подробности по используемым платам** доступны на сайте [murmulator.ru](https://murmulator.ru).

### Изменения в версии 1.5.2 (2026.02.18)
- Исправлен баг определения несуществующей бутербродной PSRAM (QSPI).
- Исправлен баг с нестабильной работой на m2p2.
- *Добавлены баги, которые забыл добавить в прошлый раз ;)*
...
- **Разработки AlexEkb** — за вклад в развитие проекта (ссылка будет добавлена позже)
- **Автор прошивки** — за проделанную работу и "добавленные баги" ;)
- **Сообщество murmulator.ru** — за поддержку и обратную связь
