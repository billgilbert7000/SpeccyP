...
Write-Output "========================================"
Write-Output "BUILDING MURM1 (GSP_FULL)"
Write-Output "========================================"
Write-Output ""
...
# Варианты: p1 и p2 с правильными именами файлов
$builds = @(
    @{Board=$board; Chip="p1"; TargetName="SpeccyP_${Version}GS_m1p1.uf2"},
    @{Board=$board; Chip="p2"; TargetName="SpeccyP_${Version}GS_m1p2.uf2"}
)
