...
2026/01/15 v1.4.0
-Очередное обновление speccyP  
- работа над ошибками и так далее



из нового/исправленного:
- Теперь используется эмулятор Z80 Manuel Sainz 
 По заявлению автора:
...
Кому интересно могут погонять тест test_z80_full.tap
...
Проверялось на этих файлах:
 pent128.tap и scorp_green.tap

- TFT по умолчанию включен  st7789 
- далее необходима настройка в Setup TFT

- Переход в режим прошивки теперь [Ctrl]+[End]

+ Прошивки для всего зоопарка плат
SpeccyP_1.4.0_LE_m2p1.uf2
SpeccyP_1.4.0_LE_m2p2.uf2
SpeccyP_1.4.0_LE_m1p2.uf2
SpeccyP_1.4.0_LE_m1p1.uf2

+ версии для MOS2 
SpeccyP_1.4.0_SE.m1p2
SpeccyP_1.4.0_SE.m2p2

+ версии для Waveshare RP2350-PiZero RP2350B 
SpeccyP_1.4.0_LE_z0p2_252Mhz.uf2
SpeccyP_1.4.0_LE_z0p2_378Mhz.uf2
+ версии для MOS2 
SpeccyP_1.4.0_SE_252Mhz.z0p2
SpeccyP_1.4.0_SE_378Mhz.z0p2

Все варианты конфигураций не тестировались!
P.S. Возможны  баги, необходимо тестирование.
Все упомянутые файлы в архиве с прошивкой. 
-------------------
# Звук 
...
!!! [Ctrl]+[End] переход в режим прошивки !!!
